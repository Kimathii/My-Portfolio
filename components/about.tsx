...
const About = () => {
  return (
    <section
      id="about"
      className="relative w-full min-h-screen bg-white dark:bg-black text-black dark:text-white flex items-center overflow-hidden py-20 lg:py-0 transition-colors duration-300 scroll-mt-16"
    >
